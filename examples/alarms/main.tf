module "bigeye" {
  source      = "git::https://github.com/bigeyedata/terraform-modules//modules/bigeye?ref=v4.4.0"
  environment = "test"
  instance    = "bigeye"
...
# Alarms module
module "alarms" {
  source                           = "git::https://github.com/bigeyedata/terraform-modules//modules/alarms?ref=v4.4.0"
