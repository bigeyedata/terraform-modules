module "bigeye" {
  source      = "git::https://github.com/bigeyedata/terraform-modules//modules/bigeye?ref=v3.15.0"
  environment = "test"
  instance    = "bigeye"
...
# Alarms module
module "alarms" {
  source                           = "git::https://github.com/bigeyedata/terraform-modules//modules/alarms?ref=v3.15.0"
