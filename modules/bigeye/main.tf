...
## handle passing in additional SG's to allow on the external LB concat(var.haproxy_extra_security_group_ids, [module.bigeye_admin.client_security_group_id])
## add listeners
...
resource "aws_lb" "external_alb" {
  ...
  security_groups    = concat(
    var.haproxy_lb_extra_security_group_ids,
    [
