...
locals {
  ...
  environment_variables = {
    ...
    BACKFILLWORK_DOMAIN_NAME  = var.backfillwork_domain_name
    ...
    ROOTCAUSEWORK_DOMAIN_NAME = var.rootcausework_domain_name
    ...
    BACKFILLWORK_ELB_NAME  = var.backfillwork_resource_name
    ...
    ROOTCAUSEWORK_ELB_NAME = var.rootcausework_resource_name
    ...
    BACKFILLWORK_ECS_NAME  = var.backfillwork_resource_name
    ...
    ROOTCAUSEWORK_ECS_NAME = var.rootcausework_resource_name
